  ...
  const experiences = [
    {
      ...
      shortDescription:
        'Multi-project CODY experience across a confidential NDA MilTech desktop platform, mobile/API products, and web/API platforms.',
      logo:
        `${import.meta.env.BASE_URL}images/codyua.jpg`,
      responsibilities: {
        en: [
          'Validate a technically complex MilTech Electron desktop application under NDA across Ubuntu, Windows, and macOS',
          'Created and maintained a 1,209-case TestRail suite mapped to requirements through a traceability matrix',
          'Covered Blai, JMES World, and SupaBox across mobile, web, API, and integration-heavy workflows',
          'Analyze requirements, clarify edge cases, design risk-based regression coverage, and investigate defects through real-time logs, API responses, database state, and Electron state/store behavior',
          'Support defect reporting, release validation, QA documentation, onboarding, mentoring, and knowledge sharing',
        ],
        ua: [
          'Валідую технічно складний MilTech Electron desktop-застосунок під NDA на Ubuntu, Windows і macOS',
          'Створив і підтримую TestRail suite на 1,209 test cases, замаплених до вимог через traceability matrix',
          'Покриваю Blai, JMES World і SupaBox у mobile, web, API та integration-heavy workflows',
          'Аналізую вимоги, уточнюю edge cases, проєктую risk-based regression coverage і розслідую дефекти через real-time логи, API responses, database state та Electron state/store behavior',
          'Підтримую defect reporting, release validation, QA documentation, onboarding, mentoring і knowledge sharing',
        ],
      },
    },
    {
